package com.C1709L.project.matrimony.configuration;
...
@ComponentScan({ "com.C1709L.project.matrimony.configuration" })
...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.C1709L.project.matrimony.model" });
